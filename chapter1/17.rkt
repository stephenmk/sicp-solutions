...
;;; Solution
;; Halve a and double b continuously until a is equal to 1.
;; We can do this because ab = (a/2)(b*2).
;; When a is not even, I make use of the fact that
;; ab = ((a-1)+1)+b = ((a-1)b) + b
;; in order to make the first argument an even number.
;; I also account for special situations in which
;; the arguments are negative, equal to 0, or equal to 1.
