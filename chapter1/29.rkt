...
;; and n and returns the value of the integral, computed using
;; Simpson's Rule. Use your procedure to integrate cube between 0 and
;; 1 (with n = 100 and n = 1000), and compare the results to those of
...
;; Procedure returns the exact value of the defined integral.
;; Value is the same result found from the integral procedure
;; shown in the book.
