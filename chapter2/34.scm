...
coefficients of the polynomial are arranged in a sequence, from a_0
through a_n.
...
#| To illustrate the algorithm, a 4th degree polynomial would look like

x { x [ x (a_4 x + a_3) + a_2] + a_1} + a_0

The "highest term" is multiplied by x and added to the next
coefficient to produce the next "highest term." This is repeated until
